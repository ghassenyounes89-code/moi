...
function App() {
  ...
  // إصلاح: إزالة الحقول غير المستخدمة
  ...
  // ✅ إصلاح: Login - إرسال email فقط
  const handleLogin = async (e) => {
    e.preventDefault()
    setLoading(true)
    try {
      const response = await axios.post("/api/visitor/login", { 
  ...
  // ✅ إصلاح: Register - إرسال name و email فقط
  ...
  // ✅ إصلاح: التعليق يتطلب تسجيل دخول فقط
  const handleCommentSubmit = async (e) => {
    ...
    setLoading(true)
    try {
      console.log("Submitting comment:", { message: commentForm.message })
      await axios.post("/api/comments", { message: commentForm.message })
        ...
        <div className="container">
          ...
          <div className="comment-form-container">
            ...
            <form onSubmit={handleCommentSubmit} className="comment-form">
              {/* ✅ إصلاح: إخفاء حقول الاسم والبريد للمستخدم المسجل */}
              {!user && (
                <>
                  <input
                    type="text"
